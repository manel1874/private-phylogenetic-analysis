...
##interface
from interface.Secure_window_acc import Secure_window_acc_Interface
from common.compute import Compute_Window

### Common class
from common.s_compute import Secure_Compute_Window

class Secure_window_acc(qtw.QWidget):
    ...
    def __init__(self,widget,clientIp,otherpartyIp,sck, *args, **kwargs):
        ...
        self.files = []
        self.ui = Secure_window_acc_Interface()
        ...
        if otherpartyIp != "":
            ip3 = otherpartyIp
            self.ui.lineEdit_3.setText(clientIp + ',' + otherpartyIp)
        else:
